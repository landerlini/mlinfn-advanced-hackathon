...
for patient in file_names:
    ...
    if patient[0:-4] in wrong_patient:
        ...
        utils.save_data_with_mask(img_res, lung_res, features_array, label_array, patient, suffix="")
        ...
        if aug == True:
            ...
            print(lung_res.max())
            utils.save_data_with_mask(aug_img, aug_mask, features_array, label_array, patient, suffix="aug")
