...
def U_net(input_size):
    ...
    Level_1_L = unet_layer_left(inputs, n_filters=8, ker_size_1=1,strides_1=1,ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_2_L = unet_layer_left(Level_1_L, n_filters=16,ker_size_1=2, strides_1=2, ker_size_2=3,strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_3_L = unet_layer_left(Level_2_L, n_filters=32, ker_size_1=2, strides_1=2, ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_4_L = unet_layer_left(Level_3_L, n_filters=64, ker_size_1=2, strides_1=2, ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_5_L = unet_layer_left(Level_4_L, n_filters=128, ker_size_1=2, strides_1=2, ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_6_L = unet_layer_bottleneck(Level_5_L, n_filters= 256, ker_size_1=1, strides_1=1, ker_size_2=3, strides_2=1, reg=0.1)
    Level_5_R = unet_layer_right(Level_6_L, Level_5_L, n_filters=128, ker_size_1=1, strides_1=1, output_pad=None, ker_size_2=3, strides_2=1, ker_size_3=3, strides_3=1, reg=0.1)
    Level_4_R = unet_layer_right(Level_5_R, Level_4_L, n_filters=64, ker_size_1=2, strides_1=2, output_pad=None,ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_3_R = unet_layer_right(Level_4_R, Level_3_L, n_filters=32, ker_size_1=2, strides_1=2, output_pad=None, ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_2_R = unet_layer_right(Level_3_R, Level_2_L, n_filters=16, ker_size_1=2, strides_1=2, output_pad=None, ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
    Level_1_R = unet_layer_right(Level_2_R, Level_1_L, n_filters=8, ker_size_1=2, strides_1=2, output_pad=None, ker_size_2=3, strides_2=1, ker_size_3=1, strides_3=1, reg = 0.1)
